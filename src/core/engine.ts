...
export class Engine {
    ...
    public static play(): void {
        ...
        else if (this.client === Client.Electron) Engine._instance!.browserFrame();
    ...
    /**
     * 2 Game loops??
     * There are 2game loops in this engine for the purposes of unit testing and multiple client usage. As this engine
